...
const connectionGuideDialogEl = document.getElementById("connectionGuideDialog");
const connectionGuideTitleEl = document.getElementById("connectionGuideTitle");
const connectionGuideIntroEl = document.getElementById("connectionGuideIntro");
const connectionGuideStepsEl = document.getElementById("connectionGuideSteps");
const connectionGuideCommandEl = document.getElementById("connectionGuideCommand");
const connectionGuideCommandTextEl = document.getElementById("connectionGuideCommandText");
const connectionGuideStatusEl = document.getElementById("connectionGuideStatus");
...
let lastCodexStatusSnapshot = null;
let pendingConnectionAction = null;
