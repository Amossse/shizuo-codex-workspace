...
export function createTaskPrompts({ codingWorkspace }) {
  ...
  function buildRemotionVideoPrompt(message, imagePaths, workDirectory) {
    ...
    return [
      ...
      "画面采用明亮温暖的纸张手稿风格，信息结构清楚，文字可读且语言跟随用户要求或最新问题，4–7 个场景，转场克制；不得臆造事实。",
